...
function UserInfo({ user, isEditingNickname, setIsEditingNickname, handleUpdateSuccess, handleDeleteClick }) {
    if (!user) {
    ...
    return (
        <div>
            ...
            {isEditingNickname ? (
                // 편집 모드일 때
                <div>
                    <UpdateNickname user={user} onUpdateSuccess={handleUpdateSuccess} />
